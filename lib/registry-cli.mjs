...
import { parseRegistry, fingerprint, strictMcpFragmentBase64, strictMcpSecretProblem } from "./registry.mjs";
...
if (!command || !file) {
  process.stderr.write("usage: registry-cli.mjs <fingerprint|strict-fragment-b64> <path>\n");
